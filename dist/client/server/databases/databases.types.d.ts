...
export interface DatabaseObject<HasPassword extends boolean = false> {
    ...
    attributes: HasPassword extends true ? DatabaseObjectAttributesWithPassword : DatabaseObjectAttributes;
}
...
} & (HasPassword extends true ? {
    password: string;
} : Record<never, never>);
//# sourceMappingURL=databases.types.d.ts.map