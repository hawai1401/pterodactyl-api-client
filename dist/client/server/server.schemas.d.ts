...
export declare const serverPermissionSchema: import("zod").ZodLiteral<"control.stop" | "control.console" | "control.start" | "control.restart" | "control.kill" | "file.sftp" | "file.update" | "file.delete" | "file.create" | "file.read" | "file.archive" | "backup.delete" | "backup.create" | "backup.read" | "backup.download" | "backup.restore" | "allocation.update" | "allocation.delete" | "allocation.create" | "allocation.read" | "database.update" | "database.delete" | "database.create" | "database.read" | "schedule.update" | "schedule.delete" | "schedule.create" | "schedule.read" | "user.update" | "user.delete" | "user.create" | "user.read" | "startup.update" | "startup.read" | "admin.websocket.install" | "admin.websocket.errors" | "admin.websocket.transfer">;
export declare const subuserPermissionSchema: import("zod").ZodUnion<readonly [import("zod").ZodLiteral<"control.stop" | "control.console" | "control.start" | "control.restart" | "control.kill" | "file.sftp" | "file.update" | "file.delete" | "file.create" | "file.read" | "file.archive" | "backup.delete" | "backup.create" | "backup.read" | "backup.download" | "backup.restore" | "allocation.update" | "allocation.delete" | "allocation.create" | "allocation.read" | "database.update" | "database.delete" | "database.create" | "database.read" | "schedule.update" | "schedule.delete" | "schedule.create" | "schedule.read" | "user.update" | "user.delete" | "user.create" | "user.read" | "startup.update" | "startup.read" | "admin.websocket.install" | "admin.websocket.errors" | "admin.websocket.transfer">, import("zod").ZodLiteral<"*">]>;
export declare const createSubuserSchema: import("zod").ZodObject<{
    email: import("zod").ZodString;
    permissions: import("zod").ZodArray<import("zod").ZodUnion<readonly [import("zod").ZodLiteral<"control.stop" | "control.console" | "control.start" | "control.restart" | "control.kill" | "file.sftp" | "file.update" | "file.delete" | "file.create" | "file.read" | "file.archive" | "backup.delete" | "backup.create" | "backup.read" | "backup.download" | "backup.restore" | "allocation.update" | "allocation.delete" | "allocation.create" | "allocation.read" | "database.update" | "database.delete" | "database.create" | "database.read" | "schedule.update" | "schedule.delete" | "schedule.create" | "schedule.read" | "user.update" | "user.delete" | "user.create" | "user.read" | "startup.update" | "startup.read" | "admin.websocket.install" | "admin.websocket.errors" | "admin.websocket.transfer">, import("zod").ZodLiteral<"*">]>>;
}, import("zod/v4/core").$strip>;
