import type { BaseFetchOptions, BasePayload, Filters, IPv4, PaginationFetchOptions, Sorts } from '../../types.js';
export type Scheme = 'https' | 'http';
export interface ListNodesOptions extends PaginationFetchOptions, Omit<BaseFetchOptions, 'force'> {
