import type { BaseFetchOptions, BasePayload, EnvironmentVariable, Filters, PaginationFetchOptions, Sorts } from '../../types.js';
export interface ApplicationServerIds {
    id?: number | undefined;
    external_id?: string | undefined;
}
export interface ListServersOptions extends PaginationFetchOptions, Omit<BaseFetchOptions, 'force'> {
    filter?: Filters<'uuid' | 'uuidShort' | 'name' | 'description' | 'image' | 'external_id'>;
    sort?: Sorts<'id' | 'uuid'>;
}
